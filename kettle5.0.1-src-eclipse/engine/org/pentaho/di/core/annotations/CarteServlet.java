 ...
 * The class needs to implement the CartePluginInterface interface
 * 
 * @author Matt Casters
 * 
 */
...
public @interface CarteServlet
{
  ...
  /** 
   * @return  The ID of the plugin. You can specify more than one ID in a comma separated format: id1,id2,id3 for deprecation purposes.
   */
  String id();
