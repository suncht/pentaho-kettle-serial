...
public class RowsFromResultMeta extends BaseStepMeta implements StepMetaInterface
{
		...
		throws KettleException
	{
        ...
        {
            throw new KettleException(BaseMessages.getString(PKG, "RowsFromResultMeta.Exception.ErrorReadingStepInfoFromRepository"), e); 
        }
	...
	throws KettleException
	{
        ...
        {
            throw new KettleException(BaseMessages.getString(PKG, "RowsFromResultMeta.Exception.UnableToSaveStepInfoToRepository")+id_step, e); 
        }
	}
    ...
    public void check(List<CheckResultInterface> remarks, TransMeta transMeta, StepMeta stepMeta, RowMetaInterface prev, String input[], String output[], RowMetaInterface info, VariableSpace space, Repository repository, IMetaStore metaStore)
	{
		...
		if (input.length>0)
		{
			CheckResult cr = new CheckResult(CheckResultInterface.TYPE_RESULT_ERROR, BaseMessages.getString(PKG, "RowsFromResultMeta.CheckResult.StepExpectingNoReadingInfoFromOtherSteps"), stepMeta); 
			remarks.add(cr);
		}
		else
		{
			CheckResult cr = new CheckResult(CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString(PKG, "RowsFromResultMeta.CheckResult.NoInputReceivedError"), stepMeta); 
			remarks.add(cr);
		}
	}
