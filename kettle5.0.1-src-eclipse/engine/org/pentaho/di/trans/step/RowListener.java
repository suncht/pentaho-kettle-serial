...
/**
 * RowListener is a listener interface for receiving row events. A class that is interested in 
 * processing a row event implements this interface, and the object created with that class is
 * registered with a component using the component's <pre>addRowListener</pre> method. When
 * the row event occurs, that object's appropriate method is invoked.
 *
 * @see RowEvent
 */
