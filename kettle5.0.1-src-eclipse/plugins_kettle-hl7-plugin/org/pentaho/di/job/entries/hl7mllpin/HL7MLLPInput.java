...
public class HL7MLLPInput extends JobEntryBase implements Cloneable, JobEntryInterface
{
  ...
  public boolean evaluates()
    ...
    /**
     * @param messageVariableName the variable name for the message to set
     */
    ...
    /**
     * @param messageTypeVariableName the message type variable name to set
     */
    ...
    /**
     * @param versionVariableName the versionVariableName to set
     */
