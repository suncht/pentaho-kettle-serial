...
public abstract class AbstractPreviewRowsXulDialog extends AbstractXulEventHandler {
  ...
  /**
   * TODO: This method should not be necessary once a XulTable can take bindings for 
   * creating xulcolumn definitions at runtime and mapping the data to the columns. 
   * 
   * @param data
   * @param columns
   */
  ...
  protected void previewStep(List<Object[]> data, List<String> columns){
    ...
    TransMeta previewMeta = TransPreviewFactory.generatePreviewTransformation(
        null, (StepMetaInterface)meta, "data_sync");
...
/*      if (previewMeta.getTransformationType() == TransformationType.Normal) {
