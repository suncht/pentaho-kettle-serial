package com.peraglobal.common.kettle.repository;
...
import com.peraglobal.core.dto.kettle.RepositoryTree;
import com.peraglobal.core.model.KRepository;

public class RepositoryUtil {

	public static Map<Integer, KettleDatabaseRepository> KettleDatabaseRepositoryCatch = new HashMap<Integer, KettleDatabaseRepository>();
	...
	public static void main(String[] args) throws KettleException{
		...
		kRepository.setDatabaseName("kettle-repository");
		kRepository.setDatabaseUsername("root");
		kRepository.setDatabasePassword("1234");
	...
	public static void disConnectionAllRepository(){
		KettleDatabaseRepositoryCatch.entrySet();
		for (Entry<Integer, KettleDatabaseRepository> entry : KettleDatabaseRepositoryCatch.entrySet()) {
