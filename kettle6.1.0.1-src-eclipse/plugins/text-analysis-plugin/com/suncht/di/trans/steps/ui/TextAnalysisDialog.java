package com.suncht.di.trans.steps.ui;
...
import com.suncht.di.trans.steps.TextAnalysisMeta;
...
public class TextAnalysisDialog extends BaseStepDialog implements StepDialogInterface {
	...
	public String open() {
		...
		shell = new Shell(parent, SWT.RESIZE | SWT.MIN | SWT.MAX);
		...
		formLayout.marginWidth = Const.MARGIN;
		formLayout.marginHeight = Const.MARGIN;
		...
		wlStepname.setText(BaseMessages.getStringEx(PKG, "步骤名称", "System.Label.StepName"));
